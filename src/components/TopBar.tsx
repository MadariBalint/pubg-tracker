...
export default function TopBar({ unknownDeaths, unknownRecalls }: TopBarProps) {
  ...
  return (
    <div className="mb-2 flex flex-col gap-3 lg:mb-5 lg:flex-row lg:items-center lg:gap-4">
      <div className="flex w-full items-center overflow-hidden border border-[#666] bg-[#212121] sm:w-auto">
      ...
      <div className="grid w-full grid-cols-2 gap-x-6 gap-y-2 sm:flex sm:w-auto sm:gap-5 lg:ml-10">
